...
const (
	MediaService_UploadMedia_FullMethodName   = "/him.media.v1.MediaService/UploadMedia"
	MediaService_DownloadMedia_FullMethodName = "/him.media.v1.MediaService/DownloadMedia"
	MediaService_GetMediaInfo_FullMethodName  = "/him.media.v1.MediaService/GetMediaInfo"
)
...
func (c *mediaServiceClient) GetMediaInfo(ctx context.Context, in *GetMediaInfoRequest, opts ...grpc.CallOption) (*GetMediaInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMediaInfoResponse)
...
func (UnimplementedMediaServiceServer) GetMediaInfo(context.Context, *GetMediaInfoRequest) (*GetMediaInfoResponse, error) {
...
var MediaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "him.media.v1.MediaService",
	...
	Metadata: "him/media/v1/media.proto",
}
