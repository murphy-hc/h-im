...
type Database struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Media         *Database_Postgres     `protobuf:"bytes,1,opt,name=media,proto3" json:"media,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Database) GetMedia() *Database_Postgres {
	if x != nil {
		return x.Media
	}
	return nil
...
const file_services_media_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x05redis\x18\x02 \x01(\v2\x15.him.media.conf.RedisR\x05redis\"\xbd\x02\n" +
	"\bDatabase\x127\n" +
	"\x05media\x18\x01 \x01(\v2!.him.media.conf.Database.PostgresR\x05media\x1a\xf7\x01\n" +
	"\bPostgres\x12$\n" +
...
var file_services_media_internal_conf_conf_proto_goTypes = []any{
	...
	(*Database_Postgres)(nil),   // 9: him.media.conf.Database.Postgres
...
var file_services_media_internal_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: him.media.conf.Database.media:type_name -> him.media.conf.Database.Postgres
	...
	10, // 14: him.media.conf.Database.Postgres.conn_max_lifetime:type_name -> google.protobuf.Duration
	10, // 15: him.media.conf.Database.Postgres.conn_max_idle_time:type_name -> google.protobuf.Duration
