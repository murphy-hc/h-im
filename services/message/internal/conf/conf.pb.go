...
// 	protoc        v6.32.1
// source: services/message/internal/conf/conf.proto
...
func (x *Bootstrap) Reset() {
	*x = Bootstrap{}
	mi := &file_services_message_internal_conf_conf_proto_msgTypes[0]
...
func (*Bootstrap) Descriptor() ([]byte, []int) {
	return file_services_message_internal_conf_conf_proto_rawDescGZIP(), []int{0}
}
...
func (x *Server) Reset() {
	*x = Server{}
	mi := &file_services_message_internal_conf_conf_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Server) Descriptor() ([]byte, []int) {
	return file_services_message_internal_conf_conf_proto_rawDescGZIP(), []int{1}
}
...
func (x *Data) Reset() {
	*x = Data{}
	mi := &file_services_message_internal_conf_conf_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Data) Descriptor() ([]byte, []int) {
	return file_services_message_internal_conf_conf_proto_rawDescGZIP(), []int{2}
}
...
type Database struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       *Database_Postgres     `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Database) GetMessage() *Database_Postgres {
	if x != nil {
		return x.Message
	}
	return nil
...
func (*Server_HTTP) Descriptor() ([]byte, []int) {
	return file_services_message_internal_conf_conf_proto_rawDescGZIP(), []int{1, 0}
}
...
func (*Server_GRPC) Descriptor() ([]byte, []int) {
	return file_services_message_internal_conf_conf_proto_rawDescGZIP(), []int{1, 1}
}
...
var File_services_message_internal_conf_conf_proto protoreflect.FileDescriptor

const file_services_message_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	")services/message/internal/conf/conf.proto\x12\x10him.message.conf\x1a\x1egoogle/protobuf/duration.proto\"\xbe\x01\n" +
	"\tBootstrap\x120\n" +
	"\x06server\x18\x01 \x01(\v2\x18.him.message.conf.ServerR\x06server\x12*\n" +
	"\x04data\x18\x02 \x01(\v2\x16.him.message.conf.DataR\x04data\x12'\n" +
	"\x03log\x18\x03 \x01(\v2\x15.him.message.conf.LogR\x03log\x12*\n" +
	"\x04otel\x18\x04 \x01(\v2\x16.him.message.conf.OtelR\x04otel\"\xd6\x02\n" +
	"\x06Server\x12\x10\n" +
	"\x03env\x18\x01 \x01(\tR\x03env\x121\n" +
	"\x04http\x18\x02 \x01(\v2\x1d.him.message.conf.Server.HTTPR\x04http\x121\n" +
	"\x04grpc\x18\x03 \x01(\v2\x1d.him.message.conf.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x05redis\x18\x02 \x01(\v2\x17.him.message.conf.RedisR\x05redis\"\xc3\x02\n" +
	"\bDatabase\x12=\n" +
	"\amessage\x18\x01 \x01(\v2#.him.message.conf.Database.PostgresR\amessage\x1a\xf7\x01\n" +
	"\bPostgres\x12$\n" +
	...
	"\ttransport\x18\a \x01(\tR\ttransportB?Z=github.com/murphy-hc/h-im/services/message/internal/conf;confb\x06proto3"

var (
	file_services_message_internal_conf_conf_proto_rawDescOnce sync.Once
	file_services_message_internal_conf_conf_proto_rawDescData []byte
)

func file_services_message_internal_conf_conf_proto_rawDescGZIP() []byte {
	file_services_message_internal_conf_conf_proto_rawDescOnce.Do(func() {
		file_services_message_internal_conf_conf_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_message_internal_conf_conf_proto_rawDesc), len(file_services_message_internal_conf_conf_proto_rawDesc)))
	})
...
var file_services_message_internal_conf_conf_proto_goTypes = []any{
	...
	(*Database_Postgres)(nil),   // 9: him.message.conf.Database.Postgres
...
var file_services_message_internal_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: him.message.conf.Database.message:type_name -> him.message.conf.Database.Postgres
	...
	10, // 14: him.message.conf.Database.Postgres.conn_max_lifetime:type_name -> google.protobuf.Duration
	10, // 15: him.message.conf.Database.Postgres.conn_max_idle_time:type_name -> google.protobuf.Duration
...
func file_services_message_internal_conf_conf_proto_init() {
	if File_services_message_internal_conf_conf_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_services_message_internal_conf_conf_proto_goTypes,
		DependencyIndexes: file_services_message_internal_conf_conf_proto_depIdxs,
		MessageInfos:      file_services_message_internal_conf_conf_proto_msgTypes,
	}.Build()
	File_services_message_internal_conf_conf_proto = out.File
	file_services_message_internal_conf_conf_proto_goTypes = nil
	file_services_message_internal_conf_conf_proto_depIdxs = nil
}
